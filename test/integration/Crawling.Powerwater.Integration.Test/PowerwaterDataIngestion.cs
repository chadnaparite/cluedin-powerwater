...
{
    public class DataIngestion : IClassFixture<PowerwaterTestFixture>
    {
        private readonly PowerwaterTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(PowerwaterTestFixture fixture, ITestOutputHelper output)
        {
