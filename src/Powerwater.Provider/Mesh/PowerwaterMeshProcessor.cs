...
{
    public class Powerwater_Command_MeshProcessor : BaseMeshProcessor
    {
        public Powerwater_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          PowerwaterConstants.ProviderId;
